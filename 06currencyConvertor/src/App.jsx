...
function App() {
  ...
  const options = Object.keys(fromCurrencyInfo)     // getting all currency codes available for a particular currency by using Object.keys(). As the values that we get from the API is an object.
